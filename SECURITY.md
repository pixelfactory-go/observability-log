...
1. **GitHub Security Advisories** (Preferred): Use the [Security Advisory](https://github.com/pixelfactory-go/observability-log/security/advisories/new) feature to privately report vulnerabilities
...
- Inject malicious content (e.g., log injection attacks)
- Compromise the integrity of logging data
...
- The observability-log library and all its components
...
- **GitHub**: https://github.com/pixelfactory-go/observability-log/security/advisories
